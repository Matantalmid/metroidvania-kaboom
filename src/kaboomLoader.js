...
k.loadSprite('drone', './assets/sprites/dr0ne.png', {
  ...
  anims: {
    ...
    explode: { from: 12, to: 17, loop: true },
  },
});
...
k.loadSprite('burner', './assets/sprites/burn3r.png', {
  ...
  sliceY: 6,
  anims: {
    adle: { from: 0, to: 3, loop: true },
    run: { from: 6, to: 8, loop: true },
    'open-fire': { from: 10, to: 14, loop: true },
    fire: { from: 15, to: 18, loop: true },
    'shut-fire': { from: 15, to: 18, loop: true },
    explode: { from: 25, to: 29, loop: true },
  },
});
